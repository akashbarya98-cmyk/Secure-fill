    ...
    <div className="flex h-screen w-full bg-[#050816] font-sans text-slate-200 overflow-hidden items-center justify-center p-4">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl font-bold text-white mb-2">Create Vault</h2>
          <p className="text-slate-400 text-sm">Start organizing your digital identity</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-xs uppercase tracking-widest font-bold text-slate-500 mb-2">Full Name</label>
            <div className="relative">
              ...
              <input 
                ...
                placeholder="Akash Ahirwar"
              />
            </div>
          </div>

          <div>
            <label className="block text-xs uppercase tracking-widest font-bold text-slate-500 mb-2 mt-2">Email Address</label>
            <div className="relative">
        ...
        <p className="text-center text-xs text-slate-500 mt-8 font-medium">
          Already have an account? <Link to="/login" className="text-blue-400 hover:text-blue-300 transition-colors font-bold">Log in</Link>
        </p>
      </motion.div>
    </div>
  );
